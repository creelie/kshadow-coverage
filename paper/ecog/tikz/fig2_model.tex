...
\begin{scope}[shift={(-2.4,-9.35)}]
  ...
  \node[anchor=west, font=\footnotesize] at (3.2,-0.65) {multiplicity $m=1,2$ in (a), (d)};
  \fill[cViolet!42] (8.35,-0.85) rectangle ++(0.4,0.4);
  \node[anchor=west, font=\footnotesize] at (8.8,-0.65) {the doubly covered region $R_2$ in (c), (f)};
\end{scope}
\end{tikzpicture}
\end{document}
